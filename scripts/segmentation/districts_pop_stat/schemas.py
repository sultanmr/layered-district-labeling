...
class DistrictsPopStatTag(BaseModel):
    ...
    def get_all_tags(cls):
        return [
            ...
            DistrictsPopStatTag(
                ...
                description="Above median number of districts_pop_stat per capita",
                rule="districts_pop_stat_per_capita > median_districts_pop_stat_per_capita"
            ),
            DistrictsPopStatTag(
                tag="#underserved", 
                category=TagCategory.DENSITY,
                description="Below 50% of median districts_pop_stat per capita",
                rule="districts_pop_stat_per_capita < 0.5 * median_districts_pop_stat_per_capita"
            )
        ]
