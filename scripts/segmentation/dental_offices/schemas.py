...
class DentalOfficesTag(BaseModel):
    ...
    def get_all_tags(cls):
        return [
            ...
            DentalOfficesTag(
                ...
                description="Above median number of dental_offices per capita",
                rule="dental_offices_per_capita > median_dental_offices_per_capita"
            ),
            DentalOfficesTag(
                tag="#underserved", 
                category=TagCategory.DENSITY,
                description="Below 50% of median dental_offices per capita",
                rule="dental_offices_per_capita < 0.5 * median_dental_offices_per_capita"
            )
        ]
