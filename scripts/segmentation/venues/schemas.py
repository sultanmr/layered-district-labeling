    ...
    def get_all_tags(cls):
        return [
            ...
            VenuesTag(
                ...
                description="Above median number of venues per capita",
                rule="venues_per_capita > median_venues_per_capita"
            ),
            VenuesTag(
                tag="#underserved", 
                category=TagCategory.DENSITY,
                description="Below 50% of median venues per capita",
                rule="venues_per_capita < 0.5 * median_venues_per_capita"
            )
        ]
