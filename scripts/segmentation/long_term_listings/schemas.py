...
class LongTermListingsTag(BaseModel):
    ...
    def get_all_tags(cls):
        return [
            ...
            LongTermListingsTag(
                ...
                description="Above median number of long_term_listings per capita",
                rule="long_term_listings_per_capita > median_long_term_listings_per_capita"
            ),
            LongTermListingsTag(
                tag="#underserved", 
                category=TagCategory.DENSITY,
                description="Below 50% of median long_term_listings per capita",
                rule="long_term_listings_per_capita < 0.5 * median_long_term_listings_per_capita"
            )
        ]
