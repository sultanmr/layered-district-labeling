...
class UniversitiesTag(BaseModel):
    ...
    def get_all_tags(cls):
        return [
            ...
            UniversitiesTag(
                ...
                description="Above median number of universities per capita",
                rule="universities_per_capita > median_universities_per_capita"
            ),
            UniversitiesTag(
                tag="#underserved", 
                category=TagCategory.DENSITY,
                description="Below 50% of median universities per capita",
                rule="universities_per_capita < 0.5 * median_universities_per_capita"
            )
        ]
