    ...
    def get_all_tags(cls):
        return [
            ...
            PoolsTag(
                ...
                description="Above median number of pools per capita",
                rule="pools_per_capita > median_pools_per_capita"
            ),
            PoolsTag(
                tag="#underserved", 
                category=TagCategory.DENSITY,
                description="Below 50% of median pools per capita",
                rule="pools_per_capita < 0.5 * median_pools_per_capita"
            )
        ]
