...
class PlaygroundsTag(BaseModel):
    ...
    def get_all_tags(cls):
        return [
            ...
            PlaygroundsTag(
                ...
                description="Above median number of playgrounds per capita",
                rule="playgrounds_per_capita > median_playgrounds_per_capita"
            ),
            PlaygroundsTag(
                tag="#underserved", 
                category=TagCategory.DENSITY,
                description="Below 50% of median playgrounds per capita",
                rule="playgrounds_per_capita < 0.5 * median_playgrounds_per_capita"
            )
        ]
