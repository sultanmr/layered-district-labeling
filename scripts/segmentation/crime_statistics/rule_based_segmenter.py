...
class CrimeStatisticsRuleBasedSegmenter(SegmentationStrategy):
    ...
    def segment(self, features: pd.DataFrame):
        ...
        median_per_capita = features['crime_statistics_per_capita'].median()

        features['#well-served'] = features['crime_statistics_per_capita'] > median_per_capita
        features['#underserved'] = features['crime_statistics_per_capita'] < median_per_capita * 0.5
