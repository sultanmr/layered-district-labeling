...
class CrimeStatisticsTag(BaseModel):
    ...
    def get_all_tags(cls):
        return [
            ...
            CrimeStatisticsTag(
                ...
                description="Above median number of crime_statistics per capita",
                rule="crime_statistics_per_capita > median_crime_statistics_per_capita"
            ),
            CrimeStatisticsTag(
                tag="#underserved", 
                category=TagCategory.DENSITY,
                description="Below 50% of median crime_statistics per capita",
                rule="crime_statistics_per_capita < 0.5 * median_crime_statistics_per_capita"
            )
        ]
