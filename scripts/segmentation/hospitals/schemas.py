    ...
    def get_all_tags(cls):
        return [
            ...
            HospitalsTag(
                ...
                description="Above median number of hospitals per capita",
                rule="hospitals_per_capita > median_hospitals_per_capita"
            ),
            HospitalsTag(
                tag="#underserved", 
                category=TagCategory.DENSITY,
                description="Below 50% of median hospitals per capita",
                rule="hospitals_per_capita < 0.5 * median_hospitals_per_capita"
            )
        ]
