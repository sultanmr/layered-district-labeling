...
class MilieuschutzProtectionZonesTag(BaseModel):
    ...
    def get_all_tags(cls):
        return [
            # Density tags
            MilieuschutzProtectionZonesTag(
                tag="#well-served",
                category=TagCategory.DENSITY,
                description="Above median number of milieuschutz_protection_zones per capita",
                rule="milieuschutz_protection_zones_per_capita > median_milieuschutz_protection_zones_per_capita"
            ),
            MilieuschutzProtectionZonesTag(
                tag="#underserved", 
                category=TagCategory.DENSITY,
                description="Below 50% of median milieuschutz_protection_zones per capita",
                rule="milieuschutz_protection_zones_per_capita < 0.5 * median_milieuschutz_protection_zones_per_capita"
            )
        ]
