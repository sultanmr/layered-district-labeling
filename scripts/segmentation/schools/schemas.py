    ...
    def get_all_tags(cls):
        return [
            ...
            SchoolsTag(
                ...
                description="Above median number of schools per capita",
                rule="schools_per_capita > median_schools_per_capita"
            ),
            SchoolsTag(
                tag="#underserved", 
                category=TagCategory.DENSITY,
                description="Below 50% of median schools per capita",
                rule="schools_per_capita < 0.5 * median_schools_per_capita"
            )
        ]
