    ...
    def get_all_tags(cls):
        return [
            ...
            SbahnTag(
                ...
                description="Above median number of sbahn per capita",
                rule="sbahn_per_capita > median_sbahn_per_capita"
            ),
            SbahnTag(
                tag="#underserved", 
                category=TagCategory.DENSITY,
                description="Below 50% of median sbahn per capita",
                rule="sbahn_per_capita < 0.5 * median_sbahn_per_capita"
            )
        ]
