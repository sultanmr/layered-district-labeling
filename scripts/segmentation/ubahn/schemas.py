    ...
    def get_all_tags(cls):
        return [
            ...
            UbahnTag(
                ...
                description="Above median number of ubahn per capita",
                rule="ubahn_per_capita > median_ubahn_per_capita"
            ),
            UbahnTag(
                tag="#underserved", 
                category=TagCategory.DENSITY,
                description="Below 50% of median ubahn per capita",
                rule="ubahn_per_capita < 0.5 * median_ubahn_per_capita"
            )
        ]
