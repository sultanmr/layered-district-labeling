    ...
    def get_all_tags(cls):
        return [
            ...
            LandPricesTag(
                ...
                description="Above median number of land_prices per capita",
                rule="land_prices_per_capita > median_land_prices_per_capita"
            ),
            LandPricesTag(
                tag="#underserved", 
                category=TagCategory.DENSITY,
                description="Below 50% of median land_prices per capita",
                rule="land_prices_per_capita < 0.5 * median_land_prices_per_capita"
            )
        ]
